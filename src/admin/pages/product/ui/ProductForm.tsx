                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {errors.slug && (
                                        <p className="text-red-500 text-sm">
                                            {errors.slug.message || 'El slug es rquerido.'}
                                        </p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.description && (
                                        <p className="text-red-500 text-sm">El slug es rquerido.</p>
                                    )}
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {product.images.map((image, index) => (
                                        <div key={index} className="relative group">
                                            ...
                                            <button className="absolute top-2 right-2 p-1 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200" type="button">
                                                <X className="h-3 w-3" />
                                            </button>
